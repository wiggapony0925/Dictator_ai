...
import { Dialog, Button, Flex, Text, TextField, Select, Slider, RadioCards, Box } from '@radix-ui/themes';
            ...
            <Dialog.Content style={{ maxWidth: 500 }}>
                ...
                <Flex direction="column" gap="4">
                    ...
                    <Box>
                        ...
                        <RadioCards.Root value={modelStrategy} onValueChange={(v: any) => setModelStrategy(v)} columns={{ initial: '1', sm: '2' }}>
